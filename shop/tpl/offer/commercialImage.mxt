<div id="lock-background">
  <div id="popup">
    ...
    <p>Choose a file on your computer to upload and use as a regular picture for your offer.</p>
    <form action="/offer/update-commercialImage" method="post" enctype="multipart/form-data">
      <fieldset>
