...
define("LOGO_DIR", "../static/img/o/"); // Path to use to access to the folder from that script.
define("SAVE_DIR", "/img/o/");           // Path to use to access to the folder from a www page.
